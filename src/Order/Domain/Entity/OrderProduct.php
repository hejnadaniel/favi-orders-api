...
final class OrderProduct
{
    ...
    public function __construct(Order $order, int $position, ProductLine $productLine)
    {
        $this->id = Uuid::v7();
        $this->order = $order;
        $this->position = $position;
        $this->productId = $productLine->productId;
        $this->name = $productLine->name;
        $this->price = $productLine->price->value;
        $this->quantity = $productLine->quantity;
    }
}
