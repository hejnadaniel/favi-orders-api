...
final class DecimalAmountTest extends TestCase
{
    ...
    public function testNormalisesToTwoFractionalDigits(string $amount, string $expected): void
    {
        self::assertSame($expected, new DecimalAmount($amount)->value);
    }

    #[DataProvider('provideMalformedAmounts')]
    public function testRejectsMalformedInput(string $amount): void
    {
        $this->expectException(InvalidOrderException::class);

        new DecimalAmount($amount);
    }
}
